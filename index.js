  ...
  function main() {
    ...
    for (var i=0.0; i<=360; i+=1) {
      ...
      var vert1 = [
        ...
        0.0, 0.1765, 0.8157, 0.9255
      ];
      var vert2 = [
        -0.08 + Math.sin(j) * 0.075 + 0.05,
        Math.cos(j) * 0.075 + 0.05,
        0.0, 0.1765, 0.8157, 0.9255
      ];
    ...
    for (var i=0.0; i<=360; i+=1) {
      var j = i * Math.PI / 180;
      var vert3 = [
        0.12 + Math.sin(j) * 0.15 + -0.15,
        Math.cos(j) * 0.15 + -0.15,
        0.0, 0.1765, 0.8157, 0.9255
      ];
      var vert4 = [
        0.12 + Math.sin(j) * 0.075 + -0.15,
        Math.cos(j) * 0.075 + -0.15,
        0.0, 0.1765, 0.8157, 0.9255
      ];
      
      vertices4 = vertices4.concat(vert3);
